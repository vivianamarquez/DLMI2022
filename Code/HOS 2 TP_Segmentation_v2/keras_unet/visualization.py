...
def plot_overlay_segmentation(x, y, spacing=(1,1), step=1, alpha = 0.3):
    ...
    # ground truth and prediction
        ...
        true_color[true == 1] = (1,0,0, alpha)
        true_color[true == 2] = (0,1,0, alpha)
        true_color[true == 3] = (0,0,1, alpha)
        true_color[true == 4] = (0,1,1, alpha)
        true_color[true == 5] = (1,0,1, alpha)
        true_color[true == 6] = (1,1,0, alpha)
...
def save_segmentation(x, y, save_filename, alpha=0.3):
...
def save_overlay_segmentation(x, y, save_path=None, spacing=(1,1), step=1, alpha=0.3):
    asp = spacing[0]/spacing[1]
...
def plot_compare_segmentation(x, y_true, y_pred, save_path=None, spacing=(1,1), step=1, alpha=0.3):  
    asp = spacing[0]/spacing[1]
    ...
    # ground truth and prediction
        ...
        pred_color[pred == 1] = (1,0,0, alpha)
        pred_color[pred == 2] = (0,1,0, alpha)
        pred_color[pred == 3] = (0,0,1, alpha)
        pred_color[pred == 4] = (0,1,1, alpha)
        pred_color[pred == 5] = (1,0,1, alpha)
        pred_color[pred == 6] = (1,1,0, alpha)
